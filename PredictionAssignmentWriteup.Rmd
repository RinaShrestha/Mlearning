...
The main objective of this project is to predict the manner in which people exercise.

The data for this project has been used from source: http://groupware.les.inf.puc-rio.br/har.
